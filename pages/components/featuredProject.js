    ...
    return (
        <div>
            ...
            <div style={{ margin: " 90px 0 50px 0" }}>
                <h4 className="acivities-header">FEATURED PROJECT </h4>
                ...
                <div>
                    ...
                    <div className="feature-container"  >
                        <div className="feature-card">
                            ...
                            <div>
                                <h3 className='red'>
                                    INTEGRATED DIGITAL SERVICE DELIVERY PLATFORM FOR MINISTRY OF CHITTAGONG HILL TRACTS AFFAIRS (MOCHTA)
                                </h3>
                        ...
                        <div className="feature-card">
                            ...
                            <div>
                                <h3 className='red'>
                                    WEB BASED NATIONAL ENQUIRY POINT FOR TRADE AND MOBILE APPS DEVELOPMENT FOR BTP
                                </h3>
                        ...
                        <div className="feature-card">
                            ...
                            <div>
                                <h3 className='red'>
                                    WEB AND MOBILE APP FOR INFRASTRUCTURE PROJECT MANAGEMENT FOR HED
